    ...
    <?php else: ?>
      <div class="p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors group">
        <div class="flex flex-col items-center text-center space-y-2">
          ...
          <span class="text-2xl font-bold text-gray-800"><?= esc($announcement['soil_type'] ?? 'Não informado') ?></span>
          <span class="text-sm text-gray-600">Tipo de Solo</span>
        </div>
      </div>
      ...
      <div class="p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors group">
        <div class="flex flex-col items-center text-center space-y-2">
          ...
          <span class="text-2xl font-bold text-gray-800"><?= ($announcement['topography'] == 'flat') ? 'Plano' : 'Aclive/declive' ?></span>
          <span class="text-sm text-gray-600">Topografia</span>
        </div>
      </div>
