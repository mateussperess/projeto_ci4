...
<body class="bg-gray-100">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-4">
          ...
          <select id="statusFilter" onchange="filterAnnouncementsTable()" class="border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
  ...
  <script src="<?= base_url('public/js/broker/evaluated_list.js') ?>" async></script>
